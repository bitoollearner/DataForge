...
4. **Events & Timestamps**  
   Event-based records designed for time-series analysis.
...
⚠️ **Important:**  
Synthetic data generated by DataForge should not be used directly for production decision-making or machine learning model evaluation without proper validation.
